...
To display the curly brackets instead of attempting to use the tag, 
simply do two of them in a row {{

It is important to note that color changes are persistant.

So if I change the {|red}background to red then change the {cyan}foreground to cyan, you'll 
notice that the background is still red{reset}
To reset the colors in a template, simply put a reset tag where you would like
to change everything back to default.

You can leave options you don't wish to change blank.  
